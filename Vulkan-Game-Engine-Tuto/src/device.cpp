...
void Device::_createInstance() {
    ...
    this->_hasGflwRequiredInstanceExtensions();
}
...
void Device::_createSurface() { this->_window.createWindowSurface(this->_instance, &this->_surface_); }
...
std::vector<const char *> Device::_getRequiredExtensions() {
...
void Device::_hasGflwRequiredInstanceExtensions() {
